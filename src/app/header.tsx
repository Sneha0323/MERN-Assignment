...
export default function Header() {
    ...
    return (
        <>
        <nav className="w-full mx-auto h-24 bg-slate-50 mb-1">
               <div className="h-9 top-3 py-3 px-5 lg:px-28">
                <ul className="flex justify-end space-x-5 text-sm">
                    <li>Help</li>
               ...
               <div className="w-11/12 mx-10">
                    <div className="flex justify-between md:items-center md:flex lg:right-10">
                    <div className=" justify-between items-center left-10 md:block">
                        <a href="/">
                            <h1 className="text-3xl font-bold lg:left-10 pl-10">ECOMMERCE</h1>
                        </a>
                    </div>
                    <div>   
                        <ul className="flex space-x-6 text-base top-14.5">
                            <li className="hover:border border-slate-400 rounded-md px-1">
